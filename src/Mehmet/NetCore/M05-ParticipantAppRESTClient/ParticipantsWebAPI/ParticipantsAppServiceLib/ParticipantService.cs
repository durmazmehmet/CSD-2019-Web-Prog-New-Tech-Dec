...
namespace CSD.ParticipantsApp.Service
{
    public class ParticipantService : IParticipantService
    {
        ...
        public async Task<Participant> FindParticipantByEmailAndParticipate(string email, bool isParticipate) => await DoWorkForServiceAsync(() => m_participantRepository.FindParticipantByEmailAndParticipate(email, isParticipate), "ParticipantAppService.FindParticipantByEmailAndParticipate");
